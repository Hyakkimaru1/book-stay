...
export default function DiaglogRating(props) {
  ...
  const handleClick = () => {
    ...
    let ratingContent = { nguoiDung: state.user, danhGia: point, comment: content, phong: props.id }
        ...
        <DialogContent>
          <div className="rating">
            ...
            <div className="rating__room">
              <img width="60" height="60" src="https://cdn.luxstay.com/users/170204/vopvKF2uSyomu130qFjYS0Nt.jpg">
              </img>
            ...
            <div className="rating__star">
              <Rating
                ...
                name="half-rating-read" id="rating-point" size="large" precision={0.5} />

            </div>
            <div className="rating__content">
              <textarea className="rating__content--text" id="feedback-content" style={{ resize: "none" }} placeholder="Hãy chia sẻ cảm nhận của bạn về dịch vụ nơi đây nhé"></textarea>
            </div>
          </div>
