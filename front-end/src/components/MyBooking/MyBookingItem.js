                    ...
                    <div className="item__info">
                        ...
                        <div className="item__info--subcontent">
                            <div className="subcontent__left">
                                ...
                                <button type="" class="bt__default" id="changeAvt" onClick={()=> ratingClick(true)} >Đánh giá</button>
                                <DiaglogRating id={props.id} onChange={rating} onClose={()=> ratingClick(false)} name={props.name}></DiaglogRating>
                                </div>
