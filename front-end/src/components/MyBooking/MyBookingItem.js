        ...
        <div className="item">
          <div className="item__picture">
            ...
            <div className="item__picture--heart">
                <div style={{display:'flex',justifyContent:'space-between',flexDirection:'column'}}>
                  <p className="item__picture--heart-word">Ngày nhận</p> <p className="item__picture--heart-date">{moment(props.ngaycheckin).format('DD/MM/YYYY')}</p> 
                </div>
                <div style={{width: '1px',height: '3.5rem',backgroundColor: '#bec2c9',margin: '0 1rem'}}>
                </div>
                <div style={{display:'flex',justifyContent:'space-between',flexDirection:'column'}}>
                  <p className="item__picture--heart-word">Ngày trả</p> <p className="item__picture--heart-date">{moment(props.ngaycheckout).format('DD/MM/YYYY')}</p> 
                </div>
            </div>
          </div>
          <div className="item__info">
            <div className="item__info--name">
              ...
              { props.trangthai === 1 && moment(props.ngaycheckin).isBefore(curDate)?
              <div className="item__title--complete">
              Complete
              </div>:null
              }
              {
                props.trangthai === 1 && moment(props.ngaycheckin).isAfter(curDate)?
              <div className="item__title--complete">
              Soon
              </div>:null
              }
            ...
            <div className="item__info--subcontent">
              <div className="subcontent__left">
                ...
                <div className="subcontent__left--rating">
                  { props.trangthaiphong === 1 && props.trangthai!==0 ? <button
                    type=""
                    class="bt__default"
                    id="changeAvt"
                  ...
                  { moment(props.ngaycheckin).isBefore(curDate)&& props.danhgia === 1 && props.trangthai === 1?
                    <button
                    type=""
                    class="bt__default"
                    id="ratingbutton"
                  ...
                  { moment(props.ngaycheckin).isAfter(curDate)&&props.trangthai===1?<button
                    type=""
                    class="bt__default"
                    id="changeAvt"
                  ...
                  { props.trangthai===0 && props.trangthaiphong === 1?<button
                    type=""
                    class="bt__default"
                    style={{backgroundColor:'#222',border:'1px solid #222'}}
                    id="changeAvt"
                    onClick={getQRagain}>
                    Thanh toán lại
                  </button>: null
