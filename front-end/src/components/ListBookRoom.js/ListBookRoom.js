      ...
      <div style={{ marginTop: "10rem" }} className="row">
        ...
        >
          ...
          >
              ...
              {listFilter &&
                listFilter.map((val, i) => (
                  <div
                    ...
                    style={
                      i == itemActive ? { color: "#f68a39" } : { color: "#222" }
                    }
            ...
            <div class="navbarsearch__wrapper--box-field">
              <svg
                id="Layer_1"
              ...
              <input
                ...
                id="search-input"
                class="booking__input-text bold"
              />
            </div>
          </div>
        </div>
