...
const notifyurl = "https://6c5b2751e1d4.ngrok.io/room/momoResponsePaid";
...
module.exports = {
  sendRequest: async (amount, orderInfo, extraData) => {
    ...
    const rawSignature = "partnerCode=" + partnerCode + "&accessKey=" +
      accessKey + "&requestId=" + requestId + "&amount=" + amount +
  ...
  sendRequestRefund: (amount, transId) => {
    ...
    const rawSignature = "partnerCode=" + partnerCode + "&accessKey=" +
      accessKey + "&requestId=" + requestId + "&amount=" + amount +
      "&orderId=" + orderId + "&transId=" + transId + "&requestType=" +
      requestTypeRefund;
    //before sign HMAC SHA256 with format
    //partnerCode=$partnerCode&accessKey=$accessKey&requestId=$requestId&amount=$amount&orderId=$oderId&orderInfo=$orderInfo&returnUrl=$returnUrl&notifyUrl=$notifyUrl&extraData=$extraData
